...
//Search Product implementation to be done here
	...
	public void user_Enters_text_in_the_SearchBox(DataTable testData) throws IOException, InterruptedException 
	{
		Map<String, String> data = testData.asMap(String.class, String.class);
		searchProduct.searchProduct(data.get("productName"));
